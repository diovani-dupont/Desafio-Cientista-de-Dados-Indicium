# -*- coding: utf-8 -*-
#
# LH_CD_Diovani_Dupont documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = u'LH_CD_Diovani_Dupont'
...
htmlhelp_basename = 'lh_cd_diovani_dupontdoc'
...
latex_documents = [
    ('index',
     'lh_cd_diovani_dupont.tex',
     u'LH_CD_Diovani_Dupont Documentation',
...
man_pages = [
    ('index', 'lh_cd_diovani_dupont', u'LH_CD_Diovani_Dupont Documentation',
     [u"Diovani Dupont"], 1)
]
